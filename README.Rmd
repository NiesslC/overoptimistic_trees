...
This repository contains code and intermediate results data of the manuscript "Beyond algorithm hyperparameters: on preprocessing hyperparameters and associated pitfalls in machine learning applications" by Christina Sauer, Luzia Hanßum, Farina Hodiamont, Claudia Bausewein, Anne-Laure Boulesteix, and Theresa Ullmann. 
...
only the individual prediction error estimates are provided as intermediate results (`03_results/rdata/_resdf.RData`).  
With this data, the figures shown in the manuscript (stored in `03_results/plots`) can be reproduced.
