generate_and_eval_tree_fct = function(procedure,
                                      preproc_hp_set,
                                      task,
                                      data_test, 
                                      eval_criterion, 
  ...
  else if(procedure %in% c("preproc.hp.tune_algo.hp.tune")) {
...
generate_toeval_preproc_hp_fct = function(current_preproc_hp, preproc_hp_set, preproc_of_interest){
  toeval_preproc_hp = replicate(length(preproc_hp_set[[preproc_of_interest]]), current_preproc_hp, simplify = FALSE)
  
  # dynamically insert value of choice of interest into options to evaluate
  for(i in 1:length(preproc_hp_set[[preproc_of_interest]])){
    toeval_preproc_hp[[i]][[preproc_of_interest]] = preproc_hp_set[[preproc_of_interest]][i]
  }
